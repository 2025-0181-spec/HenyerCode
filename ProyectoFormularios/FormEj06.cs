...
namespace ProyectoFormularios
{
    public class FormEj06 : Form
    {
        ...
        public FormEj06()
        {
            this.Text = "Ejercicio 6 - Suma de N naturales";
            this.Size = new Size(540, 394);
            this.StartPosition = FormStartPosition.CenterScreen;

            Label titulo = new Label();
            titulo.Text = "Suma de los N primeros numeros naturales.";
        ...
        private void btn_Click(object? sender, EventArgs e)
        {
            try
            {
                int n = int.Parse(t0.Text);
                int suma = 0;
                System.Text.StringBuilder sb = new System.Text.StringBuilder();
                for (int x = 1; x <= n; x++) { suma += x; sb.Append(x); if (x < n) sb.Append(" + "); }
